...
| ------------------------------------------------------- | ----------------------------------- | ------------------- | -------------------------------------------- | ----------------------------------------------------------------------- |
| `capability.json`                                       | `harness/automation/results/`       | transient           | Yes                                          | Written by editor-side capability query                                 |
...
| `runtime-error-record.json`                             | `evidence/automation/<runId>/`      | transient           | Yes                                          |                                                                          |
| `build-errors.json`                                     | `evidence/automation/<runId>/`      | transient           | Yes                                          |                                                                          |
